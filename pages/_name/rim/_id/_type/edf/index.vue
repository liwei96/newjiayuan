  ...
  <div id="Zhou">
    ...
    <div class="map-con">
      ...
      <div class="map-type" @click="pop('咨询服务', 100, '详情页+咨询服务')">
        <img src="~/assets/edf-map.png" alt="" />
        <p>咨询</p>
      </div>
    </div>
    <div class="map-mm">
  ...
  async asyncData(context) {
    ...
    let [res1] = await Promise.all([
      context.$axios
        .request({
          method: "get",
          url: "/applet_edefang/periphery",
          params: { other: other, bid: id, token: token }
        })
        .then(resp => {
        ...
        if (result.info === "ok") {
          ...
          let content = `<div style="width:150px;height: 40px;box-shadow:0px 0px 5px 0px rgba(6,0,1,0.1);border-radius:20px;padding-left: 17px;position: relative;background: #fff;"
                ...
                <div
                    ...
                    10px;background-color: #D1A23D;margin-top: 4px;" id="buildbox">
                    咨询<br /> 路线</div>
