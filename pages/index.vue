<template>
  <div id="home">
    <header>
      ...
      <img src="~/assets/login.png" alt class="peo" />
    </header>
    <div class="topnav">
      <img src="~/assets/introimg.jpg" alt class="topimg" />
      <ul>
        <li>
          <img src="~/assets/mappro.png" alt />
          <p>新房</p>
        </li>
        <li>
          <img src="~/assets/mappro.png" alt />
    ...
    <div class="swipe">
      ...
      <notice-bar :scrollable="false" background="#fff" color="#646566">
        <swipe vertical class="notice-swipe" :autoplay="3000" :show-indicators="false">
          <swipe-item>内容 1内容 1内容 1内容 1内容 1内容 1内容 1</swipe-item>
    ...
    <div class="te">
      <div class="top">
        <img class="topimg" src="~/assets/logo.png" alt />
        <span>
          查看全部
      ...
      <ul>
        <li>
          <div class="li-top">
            <p class="top-area">临安</p>
            <img src="~/assets/lun02.jpg" alt />
            <p class="top-name">西投滨江五幸银...</p>
          </div>
          <div class="li-bom">
            <p class="xx">原价: 260万</p>
            <div class="pri">
              <p>省￥62000</p>
            </div>
          </div>
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            ...
            <div class="swper-con">
              <h5>印象苕溪在售毛呸房源</h5>
              <p>
                中交财富中心7.20已盛大加推3号楼，现推出特价商铺6套，双地铁口...
                <span>详细</span>
              </p>
      ...
      <div class="swiper-success">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="top">
              <h5>客户：吴女士</h5>
              <p class="time">时间：2019-05-01</p>
              <p class="name">购买群升万国天地</p>
              <img src="~/assets/lun02.jpg" alt />
            </div>
            <div class="bom">
              <p>本人看房半年有余，从去年年底到今年五月，萧山、滨江、之江转塘的楼盘基本上都看过了，要么价格...</p>
              <div class="btn">
                查看详细
                <img src="~/assets/j-more.png" alt />
              </div>
